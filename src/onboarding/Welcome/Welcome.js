...
const Welcome = React.memo(function Welcome({
  ...
  return (
    ...
    >
      <Header
        title="Welcome to Monesign"
        subtitle="Decentralised Transaction Management for your own organizations, partners and customers!"
      />
      ...
      <p
        ...
        `}
      >
        Do you need more information about Monesign?{' '}
        <Link href="http://xenturion.io/" external>
          Visit our homepage
        </Link>
      </p>
    </Layout>
...
function CreateSubtitle({ error }) {
  ...
  return 'Start your organization with Monesign'
}
